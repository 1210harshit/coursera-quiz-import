...
const xml = fs.readFileSync(require('path').join(__dirname,'management-mastery','outline','word','document.xml'), 'utf8');
...
for (const b of blocks) {
  if (b.type === 'p') {
    ...
    // this outline writes "Course Title;" with a semicolon
