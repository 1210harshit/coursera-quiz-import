...
const mods = JSON.parse(fs.readFileSync(path.join(SP, 'genai-marketing', 'quiz.json'), 'utf8'));
...
for (const mo of mods) {
  const file = path.join(OUT, `Coursera_Import_Module_${mo.num}_Graded_Quiz_GenAI_Marketing.docx`);
