...
for (const mo of mods) {
  const file = path.join(OUT, `Coursera_Import_Module_${mo.num}_Lesson_${mo.lesson}_Practice_Quiz_Emotional_Intelligence.docx`);
  console.log(`\n=== Module ${mo.num} Lesson ${mo.lesson}: ${path.basename(file)} ===`);
