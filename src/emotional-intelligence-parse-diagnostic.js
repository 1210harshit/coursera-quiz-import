// Parser for the Emotional Intelligence for Work and Life PRE-COURSE DIAGNOSTIC — one quiz, ten questions.
//
// This is the outline's "Interactive Assessment" row, titled "Pre-Course Diagnostic: Emotional
// Intelligence Readiness Self-Assessment", and it is the one assessment that is neither graded
...
if (!fs.existsSync(src)) {
  console.error(`ENOENT ${src}\nUnzip the diagnostic document first:\n`
    + `  unzip -q "EmotionalIntelligence_PreCourseDiagnostic.docx" -d work/${SLUG}/diagnostic`);
  process.exit(1);
}
...
const unit = {
  num: 1,
  title: 'Pre-Course Diagnostic: Emotional Intelligence Self-Assessment',
  questions: [],
};
