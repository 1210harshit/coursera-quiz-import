// Parser for the Emotional Intelligence for Work and Life outline — quiz-pipeline side.
...
for (const b of blocks) {
  if (b.type === 'p') {
    ...
    // Part 1 states each objective in full: "LO1: Analyze what emotional intelligence is…".
