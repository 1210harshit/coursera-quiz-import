...
//
// Empty for this course: no item name in the outline is under the minimum. The check below
// still runs, so one introduced by a later revision is caught at parse time.
const NAME_FIXUPS = {};
