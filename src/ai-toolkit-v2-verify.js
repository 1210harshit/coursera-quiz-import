...
const { map: VIDEOS } = JSON.parse(fs.readFileSync(path.join(SP, 'ai-toolkit-v2', 'outline.json'), 'utf8'));
...
for (const mo of mods) {
  const file = path.join(OUT, `Coursera_Import_Module_${mo.num}_Graded_Quiz_AI_Toolkit.docx`);
